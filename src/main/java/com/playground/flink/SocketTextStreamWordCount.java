...
/**
 * This example shows an implementation of ChaseBankDepositAnalyzer with data from a text
...
public class SocketTextStreamWordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		// execute program
		env.execute("Java ChaseBankDepositAnalyzer from SocketTextStream Example");
	}
